...
1. Browser pass at 1440px (desktop) and 375px (mobile):
  ...
  - Tone switch (Professional / Conversational) still swaps text; View LinkedIn opens [https://www.linkedin.com/in/vijayvarman](https://www.linkedin.com/in/vijayvarman).
2. Fix any visual or console issues found, then re-check the build.
3. Insert a admin login button to bottom of the web page in terms of hidden from since this is currently missing and we have already have a use case to upload resume